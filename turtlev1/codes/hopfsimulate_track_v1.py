...
# def sync_back():
#     "pos_frontleftflipper":  np.pi,
#     "pos_frontrightflipper":  0,      # opposite phase relative to front left
#     "pos_backleft":          np.pi,       # in-phase with front right
#     "pos_backright":            0,  # opposite phase relative to front right
...
joint_output_map = {
    "pos_frontleftflipper":  {"offset": 0.435, "gain": 2},
    "pos_frontrightflipper": {"offset": 0.435, "gain": 2},
    "pos_backleft":          {"offset": 0.435, "gain": 0.8},
    "pos_backright":         {"offset": 0.435, "gain": 0.8},
    "pos_frontlefthip":      {"offset": 0.435, "gain": 2},
    "pos_frontrighthip":     {"offset": 0.435, "gain": 2}
}
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    while viewer.is_running():
        ...
        for name in actuator_names:
            ...
            delta_phi = phase_offsets_diagtest[name]
